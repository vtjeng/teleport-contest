...
- Development, at `8d94b51` (2026-08-07): 1,102 of 7,765 screens and 116,818 of
  610,816 random-number values, over the development set of 33 sessions, of
  which 3 match completely.
- Reserved holdout, last evaluated at `8d94b51`: 195 of 3,640 screens, 32,614
  of 182,022 random-number values, and 1 of 11 sessions, with 0 replay errors.
  Unchanged across the last six evaluations; `docs/goal-history.md` records
  what ten such results say about effect size, capability and reachability.
