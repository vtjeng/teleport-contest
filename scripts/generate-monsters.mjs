...
#define PRINT_ENUM(name) print_enum(#name, name, &needs_comma)
    ...
    PRINT_ENUM(G_IGNORE);
    PRINT_ENUM(M1_FLY);
    PRINT_ENUM(M1_WALLWALK);
    PRINT_ENUM(M1_CLING);
    PRINT_ENUM(M1_TUNNEL);
    PRINT_ENUM(M1_NEEDPICK);
    PRINT_ENUM(M1_CONCEAL);
    PRINT_ENUM(M1_HIDE);
    PRINT_ENUM(M1_SWIM);
    PRINT_ENUM(M1_AMORPHOUS);
    PRINT_ENUM(M1_AMPHIBIOUS);
    PRINT_ENUM(M1_BREATHLESS);
    PRINT_ENUM(M1_NOTAKE);
    PRINT_ENUM(M1_NOEYES);
    PRINT_ENUM(M1_NOHANDS);
    PRINT_ENUM(M1_NOLIMBS);
    PRINT_ENUM(M1_NOHEAD);
    PRINT_ENUM(M1_MINDLESS);
    PRINT_ENUM(M1_HUMANOID);
    PRINT_ENUM(M1_ANIMAL);
    PRINT_ENUM(M1_SLITHY);
    PRINT_ENUM(M1_UNSOLID);
    PRINT_ENUM(M1_THICK_HIDE);
    PRINT_ENUM(M1_OVIPAROUS);
    PRINT_ENUM(M1_REGEN);
    PRINT_ENUM(M1_SEE_INVIS);
    PRINT_ENUM(M1_TPORT);
    PRINT_ENUM(M1_TPORT_CNTRL);
    PRINT_ENUM(M1_ACID);
    PRINT_ENUM(M1_POIS);
    PRINT_ENUM(M1_CARNIVORE);
    PRINT_ENUM(M1_HERBIVORE);
    ...
    PRINT_ENUM(MZ_LARGE);
    PRINT_ENUM(MZ_HUGE);
    PRINT_ENUM(MZ_GIGANTIC);
    PRINT_ENUM(M2_NOPOLY);
    ...
    PRINT_ENUM(M2_MERC);
    PRINT_ENUM(M2_LORD);
    PRINT_ENUM(M2_PRINCE);
    PRINT_ENUM(M2_MINION);
    PRINT_ENUM(M2_GIANT);
    PRINT_ENUM(M2_SHAPESHIFTER);
    PRINT_ENUM(M2_MALE);
    PRINT_ENUM(M2_FEMALE);
    PRINT_ENUM(M2_NEUTER);
    PRINT_ENUM(M2_PNAME);
    PRINT_ENUM(M2_HOSTILE);
    PRINT_ENUM(M2_PEACEFUL);
    PRINT_ENUM(M2_DOMESTIC);
    PRINT_ENUM(M2_WANDER);
    PRINT_ENUM(M2_STALK);
    PRINT_ENUM(M2_NASTY);
    PRINT_ENUM(M2_STRONG);
    PRINT_ENUM(M2_ROCKTHROW);
    PRINT_ENUM(M2_GREEDY);
    PRINT_ENUM(M2_JEWELS);
    PRINT_ENUM(M2_COLLECT);
    PRINT_ENUM(M2_MAGIC);
    PRINT_ENUM(M3_COVETOUS);
    PRINT_ENUM(M3_WANTSARTI);
    PRINT_ENUM(M3_WAITFORU);
    PRINT_ENUM(M3_CLOSE);
    PRINT_ENUM(M3_INFRAVISION);
    PRINT_ENUM(M3_INFRAVISIBLE);
    PRINT_ENUM(M3_DISPLACES);
    PRINT_ENUM(MS_DJINNI);
    PRINT_ENUM(MS_SHRIEK);
    PRINT_ENUM(MS_LEADER);
    PRINT_ENUM(MS_NEMESIS);
    PRINT_ENUM(MS_GUARDIAN);
    PRINT_ENUM(MS_PRIEST);
    PRINT_ENUM(MR_FIRE);
    PRINT_ENUM(MR_COLD);
    PRINT_ENUM(MR_SLEEP);
    PRINT_ENUM(MR_DISINT);
    PRINT_ENUM(MR_ELEC);
    PRINT_ENUM(MR_POISON);
    PRINT_ENUM(MR_ACID);
    PRINT_ENUM(MR_STONE);
#undef PRINT_ENUM
...
// Source: include/monsters.h, include/permonst.h, include/monattk.h,
// include/monflag.h, and src/monst.c at
