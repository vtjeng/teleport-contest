...
// Run fresh C recordings for trap.c's monster magic-trap arm. The first
// segment takes the ordinary rn2(21) nonzero branch; the second takes zero,
// then reaches trapeffect_fire_trap(), thitm(), and burnarmor().
//
...
export async function runMonsterMagicTrapMatrix() {
    return runFreshMatrix({
        ...
        summaryLabel: 'MONSTER MAGIC TRAP',
        chunkLimit: 2,
    });
}
