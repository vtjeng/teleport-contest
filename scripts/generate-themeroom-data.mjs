...
function generatedSource(definitions) {
    ...
    return `// Generated by scripts/generate-themeroom-data.mjs.\n`
        ...
        + `// sourceLine is the Lua table entry's opening line. sourceKind records whether\n`
        + `// the entry uses des.map; only definitions with both map and filler belong to\n`
        + `// the extracted static filler-map subset.\n\n`
