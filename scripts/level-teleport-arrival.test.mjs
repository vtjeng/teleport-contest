...
test('the arrival matrix is a clean audited replay recipe', () => {
    ...
    // Names preserve the source-branch groupings documented beside recipe
    // construction, so a changed seed cannot silently erase matrix intent.
    const expectedCases = [
        ['branch generation', 7621004],
        ['depth-gated generation', 7621001],
        ['hobbit dagger', 7661000],
        ['hobbit sling', 7661011],
        ['hobbit elven dagger', 7661130],
        ['hobbit mithril coat', 7661513],
        ['hobbit dwarvish cloak', 8040709],
        ['stalker', 7650048],
        ['forest centaur no weapon', 7650182],
        ['forest centaur bow', 7650574],
        ['ogre leader club', 7650033],
        ['ogre leader battle axe', 7650278],
        ['troll no weapon', 7650103],
        ['troll ranseur', 9450654],
        ['troll partisan', 9449443],
        ['troll glaive', 9449967],
        ['troll spetum', 9449779],
        ['barrow wight', 7650800],
        ['amorous demon sleeper', 9461088],
        ['wumpus sleeper', 9461387],
        ['soldier polearm', 9470202],
        ['soldier spear', 9470211],
        ['stone giant sword', 9490235],
        ['stone giant gems', 9495425],
        ['court outside', 7640011],
        ['court inside', 7640059],
        ['shop hearing', 7633019],
        ['shop deaf', 7633019],
        ['autopickup single', 7641005],
        ['autopickup merge', 7660607],
        ['autopickup pile', 7660416],
        ['earth sense', 7643705],
        ['Quest arrival', 7645000],
        ['same-level no-op', 7621009],
    ];
    assert.deepEqual(
        recipe.segments.map(({ seed }, index) => [
            expectedCases[index][0],
            seed,
        ]),
        expectedCases,
    );
