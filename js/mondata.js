...
// C ref: you.h:323 mhim(), a monster's object pronoun. Same pattern as
// mhe() above but uses `.him` instead of `.he`.
export function mhim(mtmp, env = {}) {
    return genders[pronoun_gender(mtmp, PRONOUN_HALLU, env)].him;
}
