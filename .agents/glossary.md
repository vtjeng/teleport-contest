...
source, recipes, recordings, and independent C replays. It does not choose
cases by JavaScript results or admit and score the batch. The orchestrator
does that after the gates in `.agents/selection.md` pass.
