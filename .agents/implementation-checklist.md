...
13. **C13 — current D:1 `trap.c` in source-owned groups:** projectiles;
    ...
    `32d8f21d821b9782994f8a93514156117c52f917`. Extract the shared
    `objnam.c` armor-name helpers next, then the rust effect. Anti-magic is
    complete at
